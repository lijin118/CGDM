...
def train(num_epoch):
    ...
    for ep in range(num_epoch):
        ...
        torch.save(G, os.path.join("models_trained","visda", "extractor.pth"))
        torch.save(F1, os.path.join("models_trained","visda", "classifier1.pth"))
        torch.save(F2, os.path.join("models_trained","visda", "classifier2.pth"))
        print('-' * 100)
